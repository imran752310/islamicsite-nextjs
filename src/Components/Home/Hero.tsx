...
const HeroSection = () => {
  return (
    <section className="w-[88%] mx-auto bg-[#0E820E] py-10 h-auto lg:h-[500px] rounded-3xl lg:relative">
      {/* Background Overlay */}
      ...
      <div 
        ...
        {/* Left Content */}
        <div  data-aos="fade-left" className="text-white mt-10 text-center lg:text-left lg:w-1/2 mb-8 lg:mb-0">
        ...
        {/* Right Image */}
        <div  data-aos="fade-right" className="lg:w-1/2 flex justify-center">
